...
saveFileName = 'outputs/kendo_allvideos.txt';
orgVideoPath = 'E:\Dataset\MVDsequences_Imgs\H265\kendo\gt_gray\';
...
for i = 1:length(testvideo)
    disinputfile = ['E:\paper_work\DIBR_experiments\Distortion\H265\kendo\Y\' testvideo{i} '\'];
