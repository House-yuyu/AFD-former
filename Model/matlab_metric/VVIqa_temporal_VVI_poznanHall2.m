...
saveFileName = 'outputs/poznanhall2_allvideos.txt';
orgVideoPath = 'E:\Dataset\MVDsequences_Imgs\H265\PoznanHall2\gt_gray\';
...
for i = 1:length(testvideo)
    disinputfile = ['E:\paper_work\DIBR_experiments\Distortion\H265\hall\Y\' testvideo{i} '\'];
