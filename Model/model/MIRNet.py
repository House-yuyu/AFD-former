...
class SKFF(nn.Module):
    ...
    def forward(self, inp_feats):
        ...
        # stx()
        attention_vectors = self.softmax(attention_vectors)  # 默认dim为1，第二个维度，即height
...
class MIRNet(nn.Module):
    def __init__(self, in_channels=3, out_channels=3, n_feat=64, kernel_size=3, stride=2, n_RRG=3, n_MSRB=2, height=3,
                 width=2, bias=False):
